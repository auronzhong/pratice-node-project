/**
 * Created by zhongwei on 16/8/12.
 */
                    ...
                    <div className="panel-body">
                        <form>
                            <div className="form-group">
                                ...
                                <input type="email" className="form-control" id="ipt-email"
                                       onChange={this.handleChange.bind(this, 'email')} placeholder=""/>
                            </div>
                            <button type="button" className="btn btn-primary" onClick={this.handleSendCode.bind(this)}>
                                发送验证码
                            </button>
                            {this.state.sent ?
                                <div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="ipt-code"
                                               onChange={this.handleChange.bind(this, 'code')} placeholder=""/>
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <button type="button" className="btn btn-primary"
                                            onClick={this.handleReset.bind(this)}>修改
                                    </button>
                                </div>
                                : null}
                        </form>
